...
export const references = [
  ...
  clinicalReference({
    id: "medlineplus-medical-words",
    titleEn: "Understanding Medical Words — Beginnings and Endings",
    titleAr: "فهم الكلمات الطبية — السوابق واللواحق",
    organizationEn: "US National Library of Medicine",
    organizationAr: "المكتبة الوطنية الأمريكية للطب",
    year: 2020,
    url: "https://medlineplus.gov/medwords/beginend3.html",
    noteEn: "Official plain-language tutorial used for independently authored word-part and terminology explanations; accessed 2026-09-05.",
    noteAr: "دليل رسمي بلغة مبسطة استخدم لشرح مقاطع المصطلحات بصياغة مستقلة؛ تم الوصول في 2026-09-05.",
  }),
  clinicalReference({
    id: "who-medication-transitions-2019",
    titleEn: "Medication Safety in Transitions of Care",
    titleAr: "سلامة الدواء عند انتقالات الرعاية",
    organizationEn: "World Health Organization",
    organizationAr: "منظمة الصحة العالمية",
    year: 2019,
    url: "https://www.who.int/docs/default-source/patient-safety/who-uhc-sds-2019-9-eng.pdf",
    noteEn: "Official technical report used for medication reconciliation and information-transfer context; accessed 2026-09-05.",
    noteAr: "تقرير تقني رسمي استخدم لسياق مطابقة الأدوية ونقل المعلومات؛ تم الوصول في 2026-09-05.",
  }),
  clinicalReference({
    id: "nice-hypertension-pregnancy-ng133",
    titleEn: "NG133 Hypertension in Pregnancy — Diagnosis and Management",
    titleAr: "إرشاد NG133 لارتفاع ضغط الدم في الحمل — التشخيص والتدبير",
    organizationEn: "National Institute for Health and Care Excellence",
    organizationAr: "المعهد الوطني للصحة وجودة الرعاية",
    year: 2019,
    url: "https://www.nice.org.uk/guidance/ng133",
    noteEn: "Official recommendations used for severe pre-eclampsia warning features and urgent escalation context; current status checked 2026-09-05.",
    noteAr: "توصيات رسمية استخدمت لسياق سمات خطر ما قبل الإرجاج الشديد والتصعيد العاجل؛ تحققت الحالة الحالية في 2026-09-05.",
  }),
  clinicalReference({
    id: "nice-neonatal-jaundice-cg98",
    titleEn: "CG98 Jaundice in Newborn Babies Under 28 Days",
    titleAr: "إرشاد CG98 لليرقان لدى حديثي الولادة دون 28 يوماً",
    organizationEn: "National Institute for Health and Care Excellence",
    organizationAr: "المعهد الوطني للصحة وجودة الرعاية",
    year: 2010,
    url: "https://www.nice.org.uk/guidance/cg98/chapter/recommendations",
    noteEn: "Official recommendations used for urgent serum bilirubin measurement and review when jaundice appears in the first 24 hours; accessed 2026-09-05.",
    noteAr: "توصيات رسمية استخدمت للقياس العاجل لبيليروبين المصل والمراجعة عند ظهور اليرقان في أول 24 ساعة؛ تم الوصول في 2026-09-05.",
  }),
  clinicalReference({
    id: "ahrq-sbar",
    titleEn: "TeamSTEPPS Tool: SBAR",
    titleAr: "أداة TeamSTEPPS: التواصل المنظم SBAR",
    organizationEn: "Agency for Healthcare Research and Quality",
    organizationAr: "وكالة أبحاث وجودة الرعاية الصحية",
    year: 2019,
    url: "https://www.ahrq.gov/teamstepps-program/curriculum/communication/tools/sbar.html",
    noteEn: "Official communication tool page used for situation, background, assessment, request and repeat-back context; accessed 2026-09-05.",
    noteAr: "صفحة أداة اتصال رسمية استخدمت لسياق الحالة والخلفية والتقييم والطلب وتكرار ما سُمِع للتحقق من الدقة؛ تم الوصول في 2026-09-05.",
  }),
  clinicalReference({
    id: "cdc-cauti-prevention",
    titleEn: "Summary of Recommendations for Prevention of Catheter-Associated Urinary Tract Infections",
    titleAr: "ملخص توصيات الوقاية من عدوى المسالك البولية المرتبطة بالقسطرة",
    organizationEn: "US Centers for Disease Control and Prevention",
    organizationAr: "المراكز الأمريكية لمكافحة الأمراض والوقاية منها",
    year: 2024,
    url: "https://www.cdc.gov/infection-control/hcp/cauti/summary-of-recommendations.html",
    noteEn: "Official recommendations used for indication review and prompt authorised catheter removal; accessed 2026-09-05.",
    noteAr: "توصيات رسمية استخدمت لمراجعة الاستطباب والإزالة السريعة المخوّلة للقسطرة؛ تم الوصول في 2026-09-05.",
  }),
  clinicalReference({
    id: "cdc-folic-acid-2026",
    titleEn: "About Folic Acid",
    titleAr: "حول حمض الفوليك",
    organizationEn: "US Centers for Disease Control and Prevention",
    organizationAr: "المراكز الأمريكية لمكافحة الأمراض والوقاية منها",
    year: 2026,
    url: "https://www.cdc.gov/folic-acid/about/index.html",
    noteEn: "Official public-health guidance used for the general 400-microgram preconception recommendation; higher-risk plans require clinician advice; accessed 2026-09-05.",
    noteAr: "إرشاد صحة عامة رسمي استخدم للتوصية العامة بـ400 ميكروغرام قبل الحمل؛ وتحتاج الخطط الأعلى خطورة إلى مشورة مختص؛ تم الوصول في 2026-09-05.",
  }),
  clinicalReference({
    id: "nhs-ng-tube-safety",
    titleEn: "Medical Device Safety — Nasogastric Tube Placement Standards",
    titleAr: "سلامة الأجهزة الطبية — معايير موضع الأنبوب الأنفي المعدي",
    organizationEn: "NHS England",
    organizationAr: "هيئة الخدمات الصحية الوطنية بإنجلترا",
    year: 2026,
    ...
    noteEn: "Official enduring safety standards used for approved initial placement confirmation and rejection of the whoosh test; accessed 2026-09-05.",
    noteAr: "معايير سلامة رسمية مستمرة استخدمت للتحقق المعتمد من الموضع الأولي ورفض اختبار صوت الاندفاع؛ تم الوصول في 2026-09-05.",
  }),
  clinicalReference({
    id: "nice-bacterial-meningitis-ng240",
    titleEn: "NG240 Bacterial Meningitis and Meningococcal Disease — Recognition, Diagnosis and Management",
    titleAr: "إرشاد NG240 لالتهاب السحايا البكتيري ومرض المكورات السحائية — التعرف والتشخيص والتدبير",
    organizationEn: "National Institute for Health and Care Excellence",
    organizationAr: "المعهد الوطني للصحة وجودة الرعاية",
    year: 2024,
    url: "https://www.nice.org.uk/guidance/ng240/chapter/Recommendations",
    noteEn: "Official recommendations used for stabilisation, timely antibiotics and lumbar puncture only when safe without clinically significant delay; accessed 2026-09-05.",
    noteAr: "توصيات رسمية استخدمت للتثبيت والمضادات في الوقت المناسب والبزل القطني فقط عندما يكون آمناً دون تأخير سريري مهم؛ تم الوصول في 2026-09-05.",
  }),
  clinicalReference({
    id: "nice-neonatal-infection-ng195",
    titleEn: "NG195 Neonatal Infection — Antibiotics for Prevention and Treatment",
    titleAr: "إرشاد NG195 لعدوى حديثي الولادة — المضادات للوقاية والعلاج",
    organizationEn: "National Institute for Health and Care Excellence",
    organizationAr: "المعهد الوطني للصحة وجودة الرعاية",
    year: 2026,
    url: "https://www.nice.org.uk/guidance/NG195/chapter/risk-factors-and-clinical-indicators-early-onset-neonatal-infection",
    noteEn: "Official guideline updated May 2026 and used for red-flag recognition, immediate assessment and treatment without waiting for final results; accessed 2026-09-05.",
    noteAr: "إرشاد رسمي محدث في مايو 2026 استخدم للتعرف على العلامات الحمراء والتقييم الفوري والعلاج دون انتظار النتائج النهائية؛ تم الوصول في 2026-09-05.",
  }),
  clinicalReference({
    id: "cdc-transmission-based-precautions",
    titleEn: "Transmission-Based Precautions",
    titleAr: "الاحتياطات المبنية على طريقة انتقال العدوى",
    organizationEn: "US Centers for Disease Control and Prevention",
    organizationAr: "المراكز الأمريكية لمكافحة الأمراض والوقاية منها",
    year: 2024,
    url: "https://www.cdc.gov/infection-control/hcp/basics/transmission-based-precautions.html",
    noteEn: "Official infection-control guidance used for source control, appropriate placement and airborne precautions; accessed 2026-09-05.",
    noteAr: "إرشاد رسمي لمكافحة العدوى استخدم للتحكم بالمصدر والمكان المناسب واحتياطات الانتقال الهوائي؛ تم الوصول في 2026-09-05.",
  }),
  clinicalReference({
    id: "aha-opioid-emergency-2025",
    titleEn: "2025 Adult and Pediatric Special Circumstances of Resuscitation — Opioid Emergencies",
    titleAr: "ظروف الإنعاش الخاصة للبالغين والأطفال 2025 — طوارئ الأفيونات",
    organizationEn: "American Heart Association",
    organizationAr: "جمعية القلب الأمريكية",
    year: 2025,
    ...
    noteEn: "Official guideline page used for early recognition, ventilation, authorised opioid antagonist use and observation for recurrent respiratory depression; accessed 2026-09-05.",
    noteAr: "صفحة إرشاد رسمية استخدمت للتعرف المبكر والتهوية واستخدام مضاد الأفيون المخوّل ومراقبة عودة تثبيط التنفس؛ تم الوصول في 2026-09-05.",
  }),
  clinicalReference({
    id: "nhs-sps-lithium",
    titleEn: "Lithium Monitoring",
    titleAr: "مراقبة الليثيوم",
    organizationEn: "NHS Specialist Pharmacy Service",
    organizationAr: "خدمة الصيدلة التخصصية التابعة لهيئة الخدمات الصحية الوطنية",
    year: 2024,
    url: "https://www.sps.nhs.uk/monitorings/lithium-monitoring/",
    noteEn: "Official professional medicines advice used for toxicity features, withholding lithium, urgent levels and specialist advice; accessed 2026-09-05.",
    noteAr: "إرشاد دوائي مهني رسمي استخدم لسمات السمّية وإيقاف الليثيوم مؤقتاً وطلب المستوى العاجل والمشورة المتخصصة؛ تم الوصول في 2026-09-05.",
  }),
  clinicalReference({
    id: "rch-cyanotic-episodes",
    titleEn: "Clinical Practice Guideline: Cyanotic Episodes in Congenital Heart Disease",
    titleAr: "إرشاد الممارسة السريرية: نوبات الازرقاق في أمراض القلب الخلقية",
    organizationEn: "Royal Children's Hospital Melbourne",
    organizationAr: "مستشفى الأطفال الملكي في ملبورن",
    year: 2022,
    url: "https://www.rch.org.au/clinicalguide/guideline_index/Cyanotic_Episodes_in_Congenital_Heart_Disease/",
    noteEn: "Publisher guideline used for calming, minimal handling, knee-to-chest positioning and early senior help; accessed 2026-09-05.",
    noteAr: "إرشاد ناشر استخدم للتهدئة وتقليل التعامل ووضع الركبتين إلى الصدر وطلب المساعدة العليا مبكراً؛ تم الوصول في 2026-09-05.",
  }),
];
