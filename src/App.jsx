...
const copy = {
  en: {
    ...
    bilingual: "Truly bilingual", bilingualBody: "Switch the complete experience without losing your place.", privateDemo: "Guest beta", privateDemoBody: "Try every scenario and question bank without an account. Progress remains only in this browser.",
    ...
    accountModelBody: "The beta works without an account. Learning progress remains on the visitor's device; account sync and the AI assistant are temporarily unavailable.",
  ...
  ar: {
    ...
    bilingualBody: "بدّل التجربة كاملة من دون أن تفقد موضعك.", privateDemo: "تجربة الضيف", privateDemoBody: "جرّب كل السيناريوهات وبنوك الأسئلة بلا حساب. يبقى التقدم داخل هذا المتصفح فقط.",
    ...
    localStorageBody: "يحتفظ هذا المتصفح على هذا الجهاز باللغة ومعرّفات التعلم المكتمل وجلسة الأسئلة المؤقتة النشطة. لا تتم مزامنة أي شيء مع حساب في النسخة العامة التجريبية. لا تدخل بيانات مرضى أو نصاً سريرياً حراً، وامسح بيانات الموقع بعد استخدام جهاز مشترك.",
    ...
    accountModelBody: "تعمل النسخة التجريبية بلا حساب. يبقى تقدم التعلم على جهاز الزائر، بينما مزامنة الحساب والمساعد الذكي غير متاحين مؤقتاً.",
  ...
  en: {
    privacy: {
      ...
      sections: [
        ...
        { title: "Processors, location and technical records", body: "OpenAI Sites delivers the pages and may process standard request, security and operational logs under its terms. Rights and support emails sent to Scenario.hq90@gmail.com are processed through Google Gmail; never send patient or confidential workplace data. Account sync and the OpenAI API assistant are disabled in this release. A Saudi cross-border-transfer assessment, processor review, Gmail retention decision and backup-deletion statement remain under qualified review." },
    ...
    terms: {
      ...
      sections: [
        ...
        { title: "Guest-only release", body: "Account registration, cloud sync and the AI assistant are temporarily unavailable. Learning progress remains in this browser. Do not enter patient or workplace-confidential information anywhere on the site." },
        ...
        { title: "Availability", body: "The beta does not offer accounts, subscriptions, checkout or payment collection. Draft content may be corrected, withdrawn or unavailable without notice." },
  ...
  ar: {
    privacy: {
      ...
      sections: [
        ...
        { title: "المعالجون والموقع والسجلات التقنية", body: "تقدم OpenAI Sites صفحات الموقع وقد تعالج سجلات الطلبات والأمان والتشغيل المعتادة وفق شروطها. وتُعالج رسائل الحقوق والدعم المرسلة إلى Scenario.hq90@gmail.com عبر Google Gmail؛ فلا ترسل بيانات مريض أو معلومات عمل سرية. مزامنة الحساب وواجهة OpenAI API للمساعد معطلتان في هذا الإصدار. يبقى تقييم النقل خارج المملكة ومراجعة المعالج وقرار الاحتفاظ في Gmail وبيان حذف النسخ الاحتياطية قيد المراجعة المؤهلة." },
        ...
        { title: "الغرض والاحتفاظ", body: "تدعم بيانات الجهاز التجربة التعليمية المطلوبة وتبقى حتى تمسح سجل التعلم أو بيانات الموقع من المتصفح. تتبع سجلات الاستضافة إعدادات المزود. وتُستخدم رسائل الدعم للرد على البلاغ وتُحتفظ وفق إعدادات Gmail للمشروع أثناء بقاء جدول الاحتفاظ النهائي قيد المراجعة." },
    ...
    terms: {
      ...
      sections: [
        ...
        { title: "إصدار للضيف فقط", body: "تسجيل الحساب والمزامنة السحابية والمساعد الذكي غير متاحة مؤقتاً. يبقى تقدم التعلم داخل هذا المتصفح. لا تدخل معلومات مريض أو بيانات عمل سرية في أي موضع من الموقع." },
        ...
        { title: "التوفر", body: "لا تقدم النسخة التجريبية حسابات أو اشتراكات أو شراء أو تحصيل مدفوعات. وقد يُصحح المحتوى الأولي أو يُسحب أو يتعذر دون إشعار." },
...
function LearningPage({ lang, t, profile, examProfile, onClearHistory, onStart, auth, syncStatus, onSignOut, onExportLearningData, accountsEnabled }) {
  ...
  return <div className="page-container learning-page"><SectionIntro eyebrow={t("learningEyebrow")} title={t("learningTitle")} body={t("learningBody")} />
    {accountsEnabled ? <Suspense fallback={null}><AccountPanel auth={auth} lang={lang} syncStatus={syncStatus} onSignOut={onSignOut} onExportLearningData={onExportLearningData} /></Suspense> : <GuestBetaPanel t={t} />}
