...
const pageCopy = {
  en: {
    ...
    singleDoseOnlyBody: "If the medication order is written as mcg/min, mcg/kg/min or mg/hr—including a nitroglycerin infusion—use the separate IV infusion calculator.",
    ...
    infusionLead: "Choose one of 23 concentration shortcuts or enter the prepared solution manually, then convert the rate specified in the medication order into mL/hr. A shortcut never selects the prescribed rate.",
    ...
    sourceOrderLegend: "Medication order",
    prescribedRate: "Rate specified in the medication order",
    rateUnit: "Order rate unit",
    selectRateUnit: "Select the exact order unit",
    rateUnitRequired: "Select the unit exactly as written in the medication order.",
    ...
    infusionWeight: "Weight used in the medication order (kg)",
    weightRequiredHint: "Required only when the medication order is weight based (/kg/).",
  ...
  ar: {
    ...
    singleDoseOnlyBody: "إذا كان أمر الدواء مكتوباً بوحدة mcg/min أو mcg/kg/min أو mg/hr—ومن ذلك تسريب النايتروغليسرين—فاستخدم حاسبة التسريب الوريدي المنفصلة.",
    ...
    calculatorResultBoundary: "يؤكد هذا الناتج العملية الحسابية فقط. أعد مطابقته مع أمر الدواء وملصق المنتج الحالي ومرجع دوائي معتمد وسياسة المنشأة قبل الاستخدام.",
    infusionTitle: "حاسبة معدل التسريب الوريدي",
    infusionLead: "اختر واحداً من 23 اختصار تركيز أو أدخل المحلول المحضّر يدوياً، ثم حوّل المعدل المحدد في أمر الدواء إلى mL/hr. لا يختار الاختصار معدل الأمر أبداً.",
    ...
    sourceOrderLegend: "أمر الدواء",
    prescribedRate: "المعدل المحدد في أمر الدواء",
    rateUnit: "وحدة معدل الأمر",
    selectRateUnit: "اختر وحدة الأمر الدقيقة",
    rateUnitRequired: "اختر الوحدة كما كُتبت تماماً في أمر الدواء.",
    rateUnitHint: "اختر الوحدة كما كُتبت تماماً؛ تُرشح الوحدات لتطابق بُعد التركيز المحدد.",
    infusionWeight: "الوزن المستخدم في أمر الدواء (kg)",
